    ...
    def transcribe(self, audio_path):
        ...
        if model_key not in whisper_model_cache:
            ...
            try:
                ...
                self.finished_signal.emit(f"Błąd podczas ładowania modelu Whisper: {e}", "error")
                return None, None
            ...
            if use_whisperx:
                ...
                try:
                    ...
                    try:
                        ...
                        if "torchaudio.io" in str(e):
                            self.status_signal.emit("Błąd w whisperx.load_audio, próba załadowania audio za pomocą librosa...", "warning")
                            import librosa
